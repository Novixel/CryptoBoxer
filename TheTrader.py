...
def CanWeTrade(current_price, lastTradePrice, lastTradeSide, base_Avail, quote_Avail):
    ...
    # DEBUG INFO
    print("\n#CANWETRADE##DEBUG###\n\tChecking of funds:",tradeFunds, whatTrade)
    print("\n#CANWETRADE#DEBUG#END###\n")
...
def ShouldWeTrade():
    ...
    # DEBUG INFO #
    print("\n#SHOULDWETRADE#DEBUG INFO###\n")
    print("\nOur last trade was a",lastTradeSide,"at the price of",lastTradePrice)
    print("\nbase avail:",base_ext,base_Avail)
    print("quot avail:",quot_ext,quote_Avail)
    print("\ntotal base:",current_base_total, base_ext)
    print("total quote:",current_quot_total, quot_ext)
    print("\nCurrent Market Price:",current_price)
    print("\nWe can make a trade with side:",whatTrade)
    print("\n#SHOULDWETRADE#DEBUG#END###\n")
    ##############
